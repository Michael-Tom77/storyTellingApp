...
export default class StoryScreen extends Component {
  ...
  likeAction = ()=>{
    if(this.state.is_liked){
            ...
            .child(this.props.route.params.story.key)
            .child("likes")
  ...
  async speechConverter(title,author,story,moral){
    var currentColor = this.state.speakerColor
    this.setState({
          ...
          <View style={styles.storyContainer}>
            <ScrollView style={styles.storyCard}>
              ...
              <View style={styles.dataContainer}>
                ...
                <View style={styles.iconContainer} >value.
                  <TouchableOpacity onPress = {()=>{
                    this.speechConverter(
                      this.props.route.params.story.value.title,
                      this.props.route.params.story.value.author,
